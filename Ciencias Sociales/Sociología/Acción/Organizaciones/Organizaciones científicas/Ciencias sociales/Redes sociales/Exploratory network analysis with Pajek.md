...
La técnica para obtener un Block model es el **Block Modeling**, este proceso puede descomponerse en los siguientes pasos, al menos en el software Pajek:
